...
ptrange = np.arange(3, 12, 1).tolist() 
...
class TreeProducer(TreeProducerCommon):
    ...
    def __init__(self, name,  **kwargs):
        ...
        self.addBranch('nelectrons_eta2p5',                  'i')
        ...
        self.addBranch('e1_eta2p5_pt',                  'f')
        self.addBranch('e1_eta2p5_eta',                  'f')
        self.addBranch('e1_eta2p5_phi',                  'f')
        self.addBranch('e2_eta2p5_pt',                  'f')
        self.addBranch('e2_eta2p5_eta',                  'f')
        self.addBranch('e2_eta2p5_phi',                  'f')
...
#            self.addBranch('dyn_doubleE' + str(pt) + '_eta1p0' ,                  '?')
            self.addBranch('dyn_doubleE' + str(pt) + '_eta1p2' ,                  '?')
#            self.addBranch('dyn_doubleE' + str(pt) + '_eta1p4' ,                  '?')
