...
from deltar             import deltaR, bestMatch, bestMatchAtVtx
from ROOT import TFile, TTree, Double, TLorentzVector
from array import array
import math
from os import listdir
from os.path import isfile, join
from TreeProducer_l1muon import *


#mypath='/eos/user/y/ytakahas/BparkingTriggerStudy_nomufilter/'
mypath='/eos/user/y/ytakahas/BparkingTriggerStudy/'
...
out = TreeProducer_l1muon('l1muon_' + str(len(onlyfiles)) + 'files_'  + str(Nevt) + 'events.root')
...
#    L1_electrons = sorted([mu for mu in L1_electrons], key = lambda e : e.pt(), reverse = True)
...
#        print ii.pt()
    ...
    for gen_mu in gps_muons:
        bm, maxdR = bestMatchAtVtx(gen_mu, L1_muons)

        out.gen_mupt[0] =  gen_mu.pt()
        out.gen_mueta[0] = gen_mu.eta()

        if bm!=None:
            out.l1mu_dr[0] = maxdR
            out.l1mu_pt[0] = bm.pt()
            out.l1mu_eta[0] = bm.eta()
        else:
            out.l1mu_dr[0] = -1
            out.l1mu_pt[0] = -1 
            out.l1mu_eta[0] = -1
...
#
#        gen_ept[0] =  gen_e.pt()
#        gen_eeta[0] = gen_e.eta()
#        gen_ephi[0] = gen_e.phi()
#
#        if bm!=None:
#            l1e_dr[0] = maxdR
#            l1e_pt[0] = bm.pt()
